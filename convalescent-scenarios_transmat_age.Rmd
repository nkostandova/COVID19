...
```{r, echo=FALSE}
seir_step_age = function(stoch.init = FALSE, Ncomp = Ncomp, ICs = InCs, sd.dw = 0.00, 
...
multiple_runs_age <- function(IC = InCs, Ncomp2 = Ncomp, plasma_p = plasma_params, paramt = parameters, SIA_r = SIA_rates, nsims = 100){
  ...
  single.sim =seir_step_age(stoch.init = FALSE, Ncomp = Ncomp2, ICs = IC, sd.dw = 0.00, 
...
```{r, echo=FALSE}
single.sim =seir_step_age(stoch.init = FALSE, Ncomp = Ncomp, ICs = InCs, sd.dw = 0.00, 
                     params = parameters, plasma = plasma_params,
                     SIA_r = SIA_rates,
                     init.min = 10, init.max = 100 ) 
...
num_sims = 100
all_sim_run1 = suppressWarnings(multiple_runs_age(nsims = num_sims))
```
...
p0 = 2000   # number of units of plasma available at day 1
p_s = c(0, 0, 0, 0, 0, 0.2, 0)    # proportion of plasma used allocated to susceptible 
p_e = rep(0, Ncomp)   # proportion of plasma used allocated to exposed
p_ia = rep(0, Ncomp)   # proportion of plasma used allocated for treatment of infected asymptomatic
p_im = rep(0, Ncomp)  # proportion of plasma used allocated for treatment of infected mild
p_is = rep(0, Ncomp) # proportion of plasma used allocated for treatment of infected severe
